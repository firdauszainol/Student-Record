...
$sql="update tblstudent set Vimage3=:vimage where id=:id";
...
<head>
	...
	<title>C-Hunter Rental Portal | Admin Update Image 3</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Student Image 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Student Image 3 Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from tblstudent where tblstudent.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
