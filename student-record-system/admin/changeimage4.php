...
$sql="update tblstudent set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>C-Hunter Portal | Admin Update Image 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Student Image 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Student Image 4 Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from tblstudent where tblstudent.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
