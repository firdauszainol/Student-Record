...
$sql="update tblstudent set Studentname=:studentname,StudentClass=:class,StudentOverview=:Studentoverview where id=:id ";
...
<label class="col-sm-2 control-label">student Title<span style="color:red">*</span></label>
<div class="col-sm-4">
