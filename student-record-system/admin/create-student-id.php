...
$sql="INSERT INTO tblstudent(StudentID,StudentName,StudentClass,StudentOverview,password,Timer,Level,Vimage1,Vimage2) VALUES(:StudentID,:StudentName,:class,:StudentOverview,:password,:Timer,:Level,:vimage1,:vimage2)";
...
if($lastInsertId)
{
$msg="Student posted successfully";
}
else 
{
...
<head>
	...
	<title>C-Hunter Portal | Admin Create Student ID</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Create Student ID</h2>
...
<label class="col-sm-2 control-label">Select Section<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-sm-10">
<textarea class="form-control" name="StudentOverview" rows="3" required></textarea>
</div>
</div>
