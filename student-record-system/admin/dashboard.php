...
<head>
	...
	<title>C-Hunter Portal | Admin Dashboard</title>
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalstudent);?></div>
													<div class="stat-panel-title text-uppercase">Student Detail</div>
												</div>
											</div>
											<a href="manage-student.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql2 ="SELECT id from tblclass ";
$query2= $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$class=$query2->rowCount();
?>

													<div class="stat-panel-number h1 "><?php echo htmlentities($class);?></div>
													<div class="stat-panel-title text-uppercase">Total Class</div>
												</div>
											</div>
