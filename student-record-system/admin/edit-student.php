...
$StudentOverview=$_POST['StudentOverview'];
...
$sql="update tblstudent set StudentID=:StudentID, StudentName=:StudentName,StudentClass=:class,StudentOverview=:StudentOverview,password=:password,Level=:Level,Timer=:Timer, where id=:id ";
$query = $dbh->prepare($sql);
$query->bindParam(':StudentID',$StudentID,PDO::PARAM_STR);
$query->bindParam(':StudentName',$StudentName,PDO::PARAM_STR);
$query->bindParam(':class',$class,PDO::PARAM_STR);
$query->bindParam(':StudentOverview',$SudentOverview,PDO::PARAM_STR);
...
<div class="form-group">
<label class="col-sm-2 control-label">Student Time Record<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-sm-10">
<textarea class="form-control" name="StudentOverview" rows="3" required><?php echo htmlentities($result->StudentOverview);?></textarea>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">Image 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 1</a>
</div>
<div class="col-sm-4">Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
