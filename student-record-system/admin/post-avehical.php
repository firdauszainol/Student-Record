...
$sql="INSERT INTO tblstudent(StudentName,StudentID,StudentClass,StudentOverview,Password,Level,Timer,Vimage1,Vimage2,Vimage3,Vimage4,Vimage5) VALUES(:studentname,:studentid,:class,:studentoverview,:password,:level,:timer,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5)";
...
<head>
	...
	<title>C-Hunter Portal | Admin Post Student</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Create Student Account</h2>
...
<div class="col-sm-10">
<textarea class="form-control" name="studentorcview" rows="3" required></textarea>
</div>
</div>
