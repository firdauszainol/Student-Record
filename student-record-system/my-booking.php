...
<title>C-Hunter Portal - My Student</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/icon1.png" alt="image">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">My Student </h5>
...
<hr />
              <?php }}  else { ?>
                <h5 align="center" style="color:red">No Students</h5> yet</h5>
              <?php } ?>
