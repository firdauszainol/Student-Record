...
<title>C-Hunter Portal | Student Listing</title>
<!--Bootstrap -->
...
$class=$_POST['class'];
$Level=$_POST['Level'];
$sql = "SELECT id from tblstudent where tblstudent.StudentClass=:class and tblstudent.Level=:Level";
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">Student ID<?php echo htmlentities($result->StudentID);?> Student ID</p>
            <ul>
              
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->Timer);?> Timer</li>
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->Level);?></li>
            </ul>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="student-details.php?stid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="student-details.php?stid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->ClassName);?> , <?php echo htmlentities($result->StudentName);?></a>
                  <p class="widget_price">Student ID<?php echo htmlentities($result->StudentID);?> Student ID</p>
                </div>
              </li>
              <?php }} ?>
