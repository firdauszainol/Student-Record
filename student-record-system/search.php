...
$sql = "SELECT tblstudent.id from tblstudent 
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <li><i class="fa fa-calendar" aria-hidden="true"> Timer : </i><?php echo htmlentities($result->Timer);?></li>
                <li><i class="fa fa-user-circle-o" aria-hidden="true"> Level : </i><?php echo htmlentities($result->Level);?></li>
            </ul>
      ...
      <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-user-circle-o" aria-hidden="true"></i> Recently Listed Class</h5>
          </div>
